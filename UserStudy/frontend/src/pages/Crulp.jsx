    ...
    return (
        <div className=" p-6 px-[10vw] flex-col space-y-3 justify-center">
            ...
            <div className="bg-gray border-4 p-6">
                ...
                <InputLayout id = {uid} condition = {"crulp"} qwerty_ur = {QWERTY_TO_CRULP} ur_qwerty = {CRULP_TO_QWERTY} targetText={stimuli[counter]} setCounter={setCounter}/>
