...
export default function Consent() {
    return (
        <div className="p-6 px-[10vw] flex-col space-y-3 ">
            ...
            <p>
                To thank you for your time, we will be pleased to make a summary of the results available to you once they have been compiled. This summary will outline the research and discuss our findings and recommendations. It will be made available through our lab website: https://spaces.facsci.ualberta.ca/edtekla/ We expect this summary to be available in May. 2025. You are also eligible to receive a gift card for $30
            </p>
            ...
            <p>
                You get to choose whether you want to complete study activities. This includes whether you answer specific questions that are part of the study. It is okay if you don't want us to use your data. We can always exclude your data while analyzing that of others. Your participation will in no way affect your course grades. Your instructors will not be told who has or has not participated. You may withdraw at any time. To withdraw, simply exit the website.
            </p>
            <p>
