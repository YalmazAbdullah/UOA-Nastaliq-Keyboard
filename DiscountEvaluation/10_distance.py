...
def edit_dist(dataset_name):
    ...
    """
    native,roman = read_tsv("Data_Discount/transformed_sentences/"+dataset_name)
    keystroke_CRULP = read_tsv("Data_Discount/transformed_keystroke/CRULP/"+dataset_name)[0]
    keystroke_Windows = read_tsv("Data_Discount/transformed_keystroke/WINDOWS/"+dataset_name)[0]
    ...
    output.to_csv("../Data_Discount/scored/distance_"+dataset_name+".csv", index=True)
