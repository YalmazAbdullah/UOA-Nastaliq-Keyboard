...
# #Note: Approx 2 min with effect size
# # NO NEED FOR KRUSKAL ONLY TWO GROUPS
# ```
...
<!--   gather(key = "Stroke", value = "Press", SameHand, SameFinger, SameKey, Reach, Hurdle) %>% -->

<!--   convert_as_factor(ID, Stroke) -->

<!-- data1_sentence_long$Stroke <- factor(data1_sentence_long$Stroke, levels = c("SameHand", "SameFinger", "SameKey", "Reach", "Hurdle")) -->

<!-- ``` -->

<!-- ```{r echo =" FALSE"} -->

<!-- ggplot(data1_sentence_long, aes(x=Keyboard, y=Press , fill=Stroke )) + geom_bar(position = "dodge", stat = "summary", fun = "sum")+scale_fill_brewer(palette = "Set2") -->
...
<!--   summary1 <- get_summary(df,"CRULP", "Stroke", "Press") -->

<!--   summary2 <- get_summary(df,"IME", "Stroke", "Press") -->

<!--   summary3 <- get_summary(df,"WINDOWS", "Stroke", "Press") -->
...
<!--   data1_sentence_long, x = "Keyboard", y = "Press", fill = "Stroke", position = position_dodge(1)) + -->

<!--   geom_boxplot(aes(x = Keyboard, y = Press, group = interaction(Keyboard, Stroke)),fill = "white", width = 0.1, position = position_dodge(1)) + -->
...
<!--     test1 %>% mutate(StrokeRepition = "SameHand"), -->

<!--     test2 %>% mutate(StrokeRepition = "SameFinger"), -->

<!--     test3 %>% mutate(StrokeRepition = "SameKey"), -->

<!--     test4 %>% mutate(StrokeRepition = "Reach"), -->

<!--     test5 %>% mutate(StrokeRepition = "Hurdle"))%>% -->

<!--     select(StrokeRepition, everything())) -->

<!-- } -->

<!-- repition_btween(data1_sentence) -->
...
<!-- repition_between_pwc(data1_sentence) -->
