...
def score(dataset_name):
    _,roman = read_tsv("Data_Discount/transformed_keystroke/CRULP/"+dataset_name)
    
    # calculate sentence scores
    inputs = {
        "CRULP":read_tsv("Data_Discount/transformed_keystroke/CRULP/"+dataset_name)[0],
        "IME":roman,
        "WINDOWS":read_tsv("Data_Discount/transformed_keystroke/WINDOWS/"+dataset_name)[0],
    }
    ...
    # Write results
    output.to_csv("../Data_Discount/scored/sentence_"+dataset_name+".csv", index=True)
